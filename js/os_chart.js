function getOsData(view, dataType)
{
    var request = $.ajax({
    url: "http://127.0.0.1:5984/proto2/_design/os/_view/all",
    crossDomain: true,
    dataType: 'jsonp',
...
function osChart(installedVersionData, view)
{
    // this returns 
    ...
    $('#container').highcharts({
                title: {
                    text: view.friendlyName + " by Android Version",
                    x: -20 //center
                },
                subtitle: {
